      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample href="components/list-group/#flush">
              {/* const horizontalType: "horizontal" | "horizontal-sm" | "horizontal-md" | "horizontal-lg" | "horizontal-xl" | "horizontal-xxl" = 'horizontal' + yourString; */}
              ...
              {[
                ...
                <CListGroup className="mb-2" layout={breakpoint as HorizontalType} key={index}>
                  <CListGroupItem>Cras justo odio</CListGroupItem>
                  <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
                  <CListGroupItem>Morbi leo risus</CListGroupItem>
                </CListGroup>
